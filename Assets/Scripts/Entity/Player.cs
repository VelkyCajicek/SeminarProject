    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0) && canAttack())
        {
            ...
            if (closestEnemy != null)
            {
                ...
                if ((distToEnemy <= (this.objectCollider.bounds.size.x+closestEnemy.objectCollider.bounds.size.x+(closestEnemy.enemyType != "spider" ? 1:0)) && facingTowardsEnemy) || (distToEnemy <= 1.5 && !facingTowardsEnemy))
                {
